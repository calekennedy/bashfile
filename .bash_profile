...
# #   Change Prompt
# #   ------------------------------------------------------------
#     # If you use bash, remove the comments for this. I use zshrc.
...
# export PATH=/usr/local/git/bin:/sw/bin/:/usr/local/bin:/usr/local/:/usr/local/sbin:/usr/local/mysql/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/local/git/bin:/usr/local/bin/:/usr/local/mysql/bin
